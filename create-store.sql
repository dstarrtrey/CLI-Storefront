...
insert into products (item_id, product_name, department_name, price, stock_quantity) values (2, 'Cheese - Grie Des Champ', 'Jewelery', 30.04, 38);
...
insert into products (item_id, product_name, department_name, price, stock_quantity) values (5, 'Cucumber - English', 'Jewelery', 73.54, 88);
...
insert into products (item_id, product_name, department_name, price, stock_quantity) values (20, 'Veal - Provimi Inside', 'Home', 10.45, 62);
